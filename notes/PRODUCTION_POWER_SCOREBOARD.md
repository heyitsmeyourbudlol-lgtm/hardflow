...
## Current snapshot (2026-09-09 06:17 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 10 today · proj 38.2/day · week_avg 9.5 (bar ≥8) [PASS] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/2 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #300 Auth + team invite capability-URL noindex (after #299) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/300); #299 Ops handoff capability-URL noindex (after #297) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/299); #297 Public widget API CORP for COEP hosts (after #294) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/297); #294 Crawl-brief OPTIONS + 405 fail-closed (after #293) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/294); #293 Agent packs hub + embed CORP distribution pins (after #292) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/293)
